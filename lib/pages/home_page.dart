...
import 'package:flutter_crush/pages/candy2.dart';
import 'package:flutter_crush/pages/candy3.dart';
                      ...
                      return GameLevelButton(
                        ...
                        onTap: () {
                          if (index==0) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => Candy2()),
                            );
                          } else if (index==1) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => Candy3()),
                            );
                          }
                        },
                      );
